...
/**
 * Clase Vista Busqueda Usuarios.
 * Pantalla De BusquedaUsuarios.
 * @author Arturo Emanuel Fonseca Ruiz.
 * @version 1.
 * @since 24/11/2023
 */
public class VistaBusquedaUsuarios extends JDialog implements Fuentes,Colores{
    private ImageIcon  ImArt = new ImageIcon(getClass().getResource("/imagenes/usuario/usu.jpeg"));
    ...
    public VistaBusquedaUsuarios(Frame owner, boolean modal){
        super(owner, modal);
    ...
    private void configuracionInicial() {
        ...
        this.setTitle("Busqueda Usuarios");
        this.setLayout(null);
    }
